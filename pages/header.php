    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="collapse">
            <ul class="navbar-nav ms-auto">
                ...
                <li><a href="action.php?page=home" class="nav-link">Calculator</a></li>
                ...
                <li class="dropdown"><a href="" class="nav-link dropdown-toggle" data-bs-target="#dropdown" data-bs-toggle="dropdown">Contact</a>
                    <ul class="dropdown-menu dropdown-menu-dark bg-danger" id="dropdown">
